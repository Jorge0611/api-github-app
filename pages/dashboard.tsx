...
const Dashboard: NextPage = () => {
	...
	function tagBackground(): string {
		const colors = ["bg-green-600","bg-purple-600","bg-blue-600","bg-emerald-600","bg-indigo-600"];
		const num: number = Math.floor(Math.random() * colors.length);
		return colors[num];
	}
	...
	return(
		<div className="bg-fixed bg-cover bg-center w-full min-h-screen" style={{ backgroundImage: `url("/background-blur.jpeg")` }}>
			<Head>
